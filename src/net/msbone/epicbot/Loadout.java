...
public class Loadout{
    ...
    //finner det beste v�penet, og setter det til primary
    while(c3 <= 2){
    ...
    //Vi finner det andt beste v�penet, og setter det til secondary
    while(c4 <= 2){
    ...
    //System.out.println("rock: " + rock);
    	...
    	Weapon.setWeapons(primary_weapon, secondary_weapon);
